...
import com.isagiongo.escola.models.Contato;
import com.isagiongo.escola.models.Curso;
import com.isagiongo.escola.models.Habilidade;
...
public class AlunoCodec implements CollectibleCodec<Aluno> {
	...
	public void encode(BsonWriter writer, Aluno aluno, EncoderContext encoderContext) {
		...
		if (notas != null) {
			...
			for (Nota nota : notas) {
				notasDocument.add(new Document().append("valor", nota.getNota()));
			}
	...
	public Aluno generateIdIfAbsentFromDocument(Aluno aluno) {
		return null;// documentHasId(aluno) ? aluno : aluno.gerarNovoId();
	}
